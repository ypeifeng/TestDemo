...
public class MyDragViewLayout2 extends ViewGroup {
    ...
    public MyDragViewLayout2(Context context) {
        super(context);
        init();
    }

    public MyDragViewLayout2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MyDragViewLayout2(Context context, AttributeSet attrs, int defStyleAttr) {
...
//          mViewDragHelper.setEdgeTrackingEnabled(ViewDragHelper.EDGE_TOP);
    ...
    private class ViewDragHelperCallBack extends ViewDragHelper.Callback {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            ViewCompat.postInvalidateOnAnimation(MyDragViewLayout2.this);
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            Log.i("ypf123456onMeasure", "measureWidth:" + measureWidth + "|measureHeight:" + measureHeight);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        Log.i("ypf123456onLayout", "mCurrentTop:" + mCurrentTop +
                "|getMeasuredHeight():" + getMeasuredHeight() +
                "|mContentView.getMeasuredHeight():" + mContentView.getMeasuredHeight() +
                "|mMenuView.getHeight():" + mMenuView.getHeight() +
                "|mCurrentTop + mMenuView.getHeight():" + (mCurrentTop + mMenuView.getHeight()) +
                "|mCurrentTop+mContentView.getMeasuredHeight()+mMenuView.getHeight():" + (mCurrentTop + mContentView.getMeasuredHeight() + mMenuView.getHeight()));
        mContentView.layout(0, mCurrentTop + mMenuView.getHeight(),
                mContentView.getMeasuredWidth(),
                mCurrentTop + mMenuView.getHeight() + getMeasuredHeight());
